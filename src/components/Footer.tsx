...
const Footer = () => {
  return (
    <footer
      className="relative bottom-0 left-0 right-0 w-full bg-white dark:bg-slate-900 border-t border-gray-200/20
      h-[500px] sm:h-[450px] md:h-[400px] overflow-y-auto md:overflow-hidden"
    >
      ...
      {/* 3D Robot Image Section - Enhanced visibility */}
      <motion.div
        className="absolute right-0 bottom-0 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 
        pointer-events-none mix-blend-multiply dark:mix-blend-screen 
        transform transition-transform duration-500 hover:scale-105"
        animate={{
          y: [0, -15, 0], // More pronounced vertical movement
          rotate: [0, 1, -1, 0], // Subtle rotation for added dynamism
      ...
      >
        <motion.img
          ...
          initial={{ opacity: 0.8 }}
          animate={{
            opacity: [0.8, 1, 0.8], // Subtle pulsing opacity
          }}
          transition={{
            duration: 1,
            repeat: Infinity,
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-12">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-12 gap-6 sm:gap-8 md:gap-12">
          {/* Brand Section */}
          <div className="col-span-2 md:col-span-4 space-y-4 sm:space-y-6">
            <div className="flex items-center gap-2 sm:gap-4">
              <img
                className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-500 ease-in-out"
          ...
          {/* Navigation Links */}
          <div className="col-span-1 sm:col-span-1 md:col-span-3 space-y-4 sm:space-y-6">
          ...
          {/* Social Links */}
          <div className="col-span-2 sm:col-span-2 md:col-span-2 space-y-4 sm:space-y-6">
            <h4 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white">
              Follow Us
            </h4>
        ...
        {/* Bottom Section */}
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200/20">
